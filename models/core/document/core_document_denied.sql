...
left join {{ ref('staging_document_denied_options') }} as staging_document_denied_options on staging_document_denied_options.id = staging_document_denied_reasons.checked_options_id
left join {{ ref('staging_document') }} as staging_document on staging_document.id = staging_document_denied_reasons.document_id
