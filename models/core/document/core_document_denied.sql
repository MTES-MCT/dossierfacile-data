...
left join {{ ref('core_document_reference') }} as core_document_reference on core_document_reference.document_sub_category = staging_document_denied_options.document_sub_category
